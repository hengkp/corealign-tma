...
html[data-theme="dark"]{color-scheme:dark;--bg:#202124;--surface:#292a2d;--surface-strong:#35363a;--fg:#f1f3f4;--muted:#bdc1c6;--border:#5f6368;--accent:#8ab4f8;--accent-deep:#aecbfa;--accent-ink:#202124;--warning:#ffe082;--warning-text:#ffe082;--warning-bg:#4d3f18;--danger:#ff9b94;--danger-text:#ffb4ae;--danger-bg:#4f2b28;--success:#8cd99e;--success-text:#a8e6b6;--success-bg:#213c2a;--purple:#8ab4f8;--purple-bg:#25324a;--cyan:#8ab4f8;--cyan-bg:#25324a;--coral:#ff9b94;--coral-bg:#4f2b28;--yellow:#ffe082;--yellow-bg:#4d3f18;--shadow:0 1px 2px rgb(0 0 0/.4)}
