...
@media(prefers-reduced-motion:reduce){*,*::before,*::after{animation-duration:.01ms!important;animation-iteration-count:1!important;transition-duration:.01ms!important;scroll-behavior:auto!important}}
    ...
    html.append('</div>')
    html.append('<div class="notice">').append(projectIcon('warning')).append('<div><strong>Confirm or edit</strong><p>Correct? Click Confirm. Wrong? Click Edit, set the angle, then Confirm. Chrome, Edge, and AppHub save directly to the project folder. Run CoreAlign again when you are ready.</p></div></div>')
    if (hasOrientation && !coreRecords.isEmpty()) {
        ...
        coreRecords.each { record ->
            ...
            html.append('<p class="core-meta">Confidence ')
                .append(asProjectDecimal(record.confidence, 3)).append('<br>Rotation ')
                .append(asProjectDecimal(record.rotateToTopDeg, 1)).append(' deg. Residual ')
                .append(asProjectDecimal(record.postRotationResidualDeg, 1)).append(' deg.</p>')
