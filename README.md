...
- Full-resolution rotated RGB PNG and lossless native UINT16 multichannel OME-TIFF
...
| `saveNativeOmeTiff` | Save lossless native multichannel crop |
...
├── source_native_ome/     # lossless UINT16 multichannel source crop
├── checkpoints/
...
The native OME-TIFF is intentionally an unresampled source archive. The presentation PNG is the rotated visual composite. Use the original slide/native OME for quantitative analysis.
